    ...
    <section>
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="radio" name="txtcombustivel" value="4.00" id="" checked><label for="">Etanol</label>
                <input type="radio" name="txtcombustivel" value="7.00" id=""><label for="">Diesel</label>
                <input type="radio" name="txtcombustivel" value="5.00" id=""><label for="">Gasolina</label>
            </div>
